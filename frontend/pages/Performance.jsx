                  ...
                  {firstStat === "good" ? (
                    <>
                      ...
                      <div className="w-[228px] ml-9 mt-2">
                        <p>첫 번째 텍스트 또는 이미지가 표시되는 시간을 나타냅니다.</p>
                      </div>
                    </>
                  ) : (
                    <>
                ...
                <div className="w-[350px] h-[120px] mx-auto lg:mr-[30%] xl:mr-[40%] 2xl:mr-[52%]">
                  ...
                  {inter === "good" ? (
                    <>
                      ...
                      <div className="w-[228px] ml-9 mt-2">
                        <p>
                          사용자가 완전히 페이지와 상호작용할 수 있게 될 때까지 걸리는 시간입니다.
                        </p>
                      </div>
                    </>
                  ) : (
                    <>
                      {inter === "soso" ? (
                        <>
                          ...
                          <div className="w-[228px] ml-9 mt-2">
                            <p>
                              사용자가 완전히 페이지와 상호작용할 수 있게 될 때까지 걸리는
                              시간입니다.
                            </p>
                          </div>
                        </>
                ...
                <div className="w-[350px] h-[120px] mx-auto lg:ml-[30%] xl:ml-[40%] 2xl:ml-[52%]">
                  ...
                  {speed === "good" ? (
                    <>
                      ...
                      <div className="w-[228px] ml-9 mt-2">
                        <p>페이지의 콘텐츠가 얼마나 빨리 표시되는지 보여줍니다.</p>
                      </div>
                    </>
                  ) : (
                    <>
                ...
                <div className="w-[350px] h-[120px] mx-auto lg:ml-[30%] xl:ml-[40%] 2xl:ml-[52%]">
                  ...
                  {largest === "good" ? (
                    <>
                      ...
                      <div className="w-[228px] ml-9 mt-2">
                        <p>
                          서비스의 용량이 가장 큰 텍스트 또는 이미지가 표시되는 시간을 나타냅니다.
                        </p>
                      </div>
                    </>
                  ) : (
                    <>
                      {largest === "soso" ? (
                        <>
                          ...
                          <div className="w-[228px] ml-9 mt-2">
                            <p>
                              서비스의 용량이 가장 큰 텍스트 또는 이미지가 표시되는 시간을
                              나타냅니다.
                            </p>
                          </div>
                        </>
                ...
                <div className="w-[350px] h-[120px] mx-auto lg:mr-[30%] xl:mr-[40%] 2xl:mr-[52%]">
                  ...
                  {layout === "good" ? (
                    <>
                      ...
                      <div className="w-[228px] ml-9 mt-2">
                        <p>화면 영역 안에 보이는 요소의 이동을 측정합니다.</p>
                      </div>
                    </>
                  ) : (
                    <>
