...
//     // api 구성되는 대로 api 요청
//     // axios
//     //   .get('/apiTest', inputObj)
//     //   .then((res) => {
//     //     const apiTestResult = res.data.result
//     //   })
//     //   .catch((err) => {
//     //     console.log(err);
//     //   })
...
//           <div class="w-full overflow-hidden lg:my-1 lg:px-1 lg:w-1/2 xl:my-1 xl:px-6 xl:w-1/4">
//             <div>
//               {btnIndex ? (
//                 <div>
//                   <div>
//                     <button onClick={clickHistory}>History</button>
//                     <button onClick={clickCollections} className="underline">
//                       Collections
//                     </button>
//                   </div>
//                   <div>
...
//                 <div>
//                   <div>
//                     <button onClick={clickHistory} className="underline">
//                       History
//                     </button>
...
//           <div class="w-full overflow-hidden lg:my-1 lg:px-1 lg:w-1/2 xl:my-1 xl:px-1 xl:w-3/4">
//             <div>
//               {/* 제목, base url */}
//               <div className="flex ">
//                 <div className="mr-2">API TEST</div>
//                 <input type="text" placeholder="base url" onChange={handlePayload} name="baseUrl" />
//               </div>
//               <div className="flex">
//                 <div className="mr-40">Untitled Request</div>
//                 <button className="border-2 border-purple-500" onClick={clickSaveBtn}>
//                   Save
//                 </button>
//               </div>
//               <div className="flex">
...
//                 />
//                 <button className="border-2 border-purple-500" onClick={clickSendBtn}>
//                   Send
//                 </button>
//               </div>
//               <div>
...
//                   <button
//                     name="params"
//                     onClick={clickOptionBtn}
//                     className={optionBtn == "params" ? "underline" : ""}
//                   >
//                     Params
//                   </button>
//                   <button
//                     name="authorization"
//                     onClick={clickOptionBtn}
//                     className={optionBtn == "authorization" ? "underline" : ""}
//                   >
//                     Authorization
//                   </button>
//                   <button
//                     name="headers"
//                     onClick={clickOptionBtn}
//                     className={optionBtn == "headers" ? "underline" : ""}
//                   >
//                     Headers
//                   </button>
//                   <button
//                     name="body"
//                     onClick={clickOptionBtn}
//                     className={optionBtn == "body" ? "underline" : ""}
//                   >
//                     Body
//                   </button>
//                   <button
//                     name="settings"
//                     onClick={clickOptionBtn}
//                     className={optionBtn == "settings" ? "underline" : ""}
//                   >
//                     Settings
//                   </button>
//                 </div>
...
//                 <div>
//                   Response
//                   <div>{responseDump.data.description}</div>
//                 </div>
//               </div>
//             </div>
//           </div>
